...
;--------------------------------------------------------
	.area _CODE
;./template.c:38: void main()
;	---------------------------------
; Function main
; ---------------------------------
_main::
;./template.c:40: VDP_SetMode(VDP_MODE_SCREEN0);
	xor	a, a
	call	_VDP_SetMode
...
;./template.c:42: VDP_ClearVRAM();
	call	_VDP_ClearVRAM
;./template.c:44: Print_SetTextFont(g_Font_MGL_Sample6, 1);
	ld	a, #0x01
	push	af
	inc	sp
	ld	hl, #_g_Font_MGL_Sample6
	call	_Print_SetTextFont
;./template.c:45: Print_SetColor(COLOR_WHITE, COLOR_BLACK);
	ld	l, #0x01
;	spillPairReg hl
;	spillPairReg hl
	ld	a, #0x0f
...
;C:/Users/socia/Documents/www/MO5/MSX/engine/src/print.h:204: g_PrintData.CursorY = y;
	...
	ld	(hl), #0x00
;./template.c:47: Print_DrawText(MSX_GL" The MSX Game Library");
	ld	hl, #___str_0
	call	_Print_DrawText
;./template.c:50: while(!Keyboard_IsKeyPressed(KEY_ESC))
	ld	c, #0x00
00101$:
	push	bc
	ld	a, #0x27
...
;C:/Users/socia/Documents/www/MO5/MSX/engine/src/print.h:204: g_PrintData.CursorY = y;
	ld	hl, #(_g_PrintData + 6)
	ld	(hl), #0x00
;./template.c:53: Print_DrawChar(g_ChrAnim[count++ % 4]);
	inc	c
	ld	a, c
	and	a, #0x03
	ld	e, a
	...
	pop	bc
;C:/Users/socia/Documents/www/MO5/MSX/engine/src/system.h:103: inline void Halt() { __asm__("halt"); }
	halt
;./template.c:54: Halt();
	jr	00101$
00103$:
;./template.c:57: Bios_Exit(0);
	xor	a, a
;./template.c:58: }
	jp	_Bios_Exit
_g_RDPRIM	=	0xf380
